          ...
          <tbody className="text-sm divide-y divide-gray-100">
            ...
            <tr>
              ...
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
                  {" "}
                  {fullDateTime(task.data.complete)}
                </div>
              </td>
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
            ...
            <tr>
              ...
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
                  Time elapsed to complete since the submission i.e. including
                  scheduling time
                </div>
              </td>
            </tr>
            <tr>
              ...
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
                  {" "}
                  {formatDuration(task.data.realtime)}
                </div>
              </td>
              <td className="p-2 whitespace-nowrap">
        ...
        <table className="table-auto w-full">
          ...
          <tbody className="text-sm divide-y divide-gray-100">
            <tr>
              ...
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
                  Container image name used to execute the task
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
                  {bytes(task.data.memory, { unitSeparator: " " })}
                </div>
              </td>
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
            ...
            <tr>
              ...
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
                  The Nextflow executor used to carry out this task
                </div>
              </td>
            </tr>
            <tr>
              ...
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
                  The virtual machine type used to carry out by this task
                </div>
              </td>
            </tr>
            <tr>
              ...
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
                  The cloud zone where the job get executed
                </div>
              </td>
            </tr>
            <tr>
              ...
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
                  The price model used to charge the job computation
                </div>
              </td>
            </tr>
          </tbody>
        ...
        <table className="table-auto w-full">
          ...
          <tbody className="text-sm divide-y divide-gray-100">
            ...
            <tr>
              ...
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
                  {bytes(task.data.rss, { unitSeparator: " " })}
                </div>
              </td>
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
            ...
            <tr>
              ...
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
                  {bytes(task.data.peakRss ?? 0, { unitSeparator: " " })}
                </div>
              </td>
              <td className="p-2 whitespace-nowrap">
            ...
            <tr>
              ...
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
                  {bytes(task.data.vmem, { unitSeparator: " " })}
                </div>
              </td>
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
            ...
            <tr>
              ...
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
                  {bytes(task.data.peakVmem ?? 0, { unitSeparator: " " })}
                </div>
              </td>
              <td className="p-2 whitespace-nowrap">
            ...
            <tr>
              ...
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
                  {bytes(task.data.rchar, { unitSeparator: " " })}
                </div>
              </td>
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
                  Number of bytes the process read, using any read-like system
                  call from files, pipes, tty, etc
                </div>
              </td>
            </tr>
            <tr>
              ...
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
                  {bytes(task.data.wchar, { unitSeparator: " " })}
                </div>
              </td>
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
                  Number of bytes the process wrote, using any write-like system
                  call.
                </div>
              </td>
            </tr>
            <tr>
              ...
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
                  {bytes(task.data.readBytes, { unitSeparator: " " })}
                </div>
              </td>
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
            ...
            <tr>
              ...
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
                  {bytes(task.data.writeBytes, { unitSeparator: " " })}
                </div>
              </td>
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
                  Number of bytes the process originally dirtied in the
                  page-cache (assuming they will go to disk later).
                </div>
              </td>
            </tr>
            <tr>
              ...
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
                  Number of read-like system call invocations that the process
                  performed
                </div>
              </td>
            </tr>
            <tr>
              ...
              <td className="p-2 whitespace-nowrap">
                <div className="text-left">
                  Number of write-like system call invocations that the process
                  performed
                </div>
              </td>
            </tr>
